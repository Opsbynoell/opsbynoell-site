  ...
  return (
    <div style={{ backgroundColor: '#FFF5F0', minHeight: '100vh' }}>
      ...
      <section style={{ position: 'relative', paddingTop: '140px', paddingBottom: '60px', overflow: 'hidden' }}>
        ...
        <div style={{ position: 'absolute', top: '5%', left: '50%', transform: 'translateX(-50%)', width: '600px', height: '600px', pointerEvents: 'none', background: 'radial-gradient(ellipse at center, rgba(255,255,255,0),0.1) 0%, transparent 70%)' }} />

        <div className="container" style={{ position: 'relative', zIndex: 1, maxWidth: '760px', margin: '0 auto' }}>
          <FadeItem delay={0}>
            <a href="/blog" style={{ display: 'inline-flex', alignItems: 'center', gap: '0.5rem', fontFamily: "'Nicholas', serif", fontSize: '0.8125rem', color: '#0CA2A2', textDecoration: 'none', marginBottom: '2rem' }}>
          ...
          <FadeItem delay={0.05}>
            <div style={{ display: 'flex', alignItems: 'center', gap: '0.75rem', marginBottom: '1.5rem', flexWrap: 'wrap' }}>
              <span style={{ display: 'inline-block', padding: '0.25rem 0.75rem', background: 'transparent', border: '1px solid #E5E5E5', borderRadius: '100px', fontFamily: "'Nicholas', serif", fontSize: '0.6875rem', fontWeight: 600, color: '#0CA2A2', letterSpacing: '0.08em', textTransform: 'uppercase' as const }}>
                {POST.category}
              </span>
              <span style={{ display: 'inline-flex', alignItems: 'center', gap: '0.375rem', fontFamily: "'Nicholas', serif", fontSize: '0.8125rem', color: '#b8b6b3' }}>
          ...
          <FadeItem delay={0.15}>
            <p style={{ fontFamily: "'Nicholas', serif", fontSize: '1.0625rem', color: '#b8b6b3', lineHeight: 1.75, marginBottom: '2rem' }}>
              {POST.excerpt}
            </p>
          </FadeItem>
          ...
          <FadeItem delay={0.2}>
            <div style={{ display: 'flex', alignItems: 'center', gap: '0.75rem', paddingTop: '1.5rem', borderTop: '1px solid rgba(12,162,162,0.12)' }}>
              ...
              <div>
                <p style={{ fontFamily: "'Nicholas', serif", fontSize: '0.875rem', fontWeight: 600, color: '#ffffff', margin: 0 }}>{POST.author}</p>
                <p style={{ fontFamily: "'Nicholas', serif", fontSize: '0.75rem', color: '#b8b6b3', margin: 0 }}>Ops by Noell</p>
              </div>
            </div>
          </FadeItem>
        </div>
        ...
        <div className="container" style={{ maxWidth: '760px', margin: '0 auto' }}>
          <FadeItem delay={0}>
            <div style={{ borderTop: '1px solid #E5E5E5', paddingTop: '3rem' }}>
              ...
              <p style={{ fontFamily: "'Nicholas', serif", fontSize: '1.0625rem', color: '#a0a8b8', lineHeight: 1.85, marginBottom: '1.5rem', fontStyle: 'italic' }}>
              ...
              <p style={{ fontFamily: "'Nicholas', serif", fontSize: '1rem', color: '#b8b6b3', lineHeight: 1.85, marginBottom: '1.25rem' }}>
              ...
              <p style={{ fontFamily: "'Nicholas', serif", fontSize: '1rem', color: '#b8b6b3', lineHeight: 1.85, marginBottom: '1.25rem' }}>
                <strong style={{ color: '#0CA2A2' }}>Missed phone calls</strong> are the most visible. A call goes to voicemail. The caller hangs up. Eighty-five percent never try again.
              </p>
              <p style={{ fontFamily: "'Nicholas', serif", fontSize: '1rem', color: '#b8b6b3', lineHeight: 1.85, marginBottom: '1.25rem' }}>
                <strong style={{ color: '#0CA2A2' }}>Unanswered website inquiries</strong> carry a similar penalty — and a tighter time window. Research from Lead Connect (2022) found that 78% of customers buy from the first business that responds to their inquiry. Not the best business. Not the cheapest. The first. If your website inquiry form sends leads to an inbox that doesn't trigger an immediate response, you're losing the majority to whoever replies faster.
              </p>
              <p style={{ fontFamily: "'Nicholas', serif", fontSize: '1rem', color: '#b8b6b3', lineHeight: 1.85, marginBottom: '1.25rem' }}>
                <strong style={{ color: '#0CA2A2' }}>Unread DMs</strong> across Instagram, Facebook, and Google Business are the quietest drain. Clients who prefer not to call — which is increasingly most people under 40 — send a message and wait. If there's no response within a few hours, they've already booked somewhere else.
              </p>
              ...
              <p style={{ fontFamily: "'Nicholas', serif", fontSize: '1rem', color: '#b8b6b3', lineHeight: 1.85, marginBottom: '1.25rem' }}>
                <strong style={{ color: '#0CA2A2' }}>Missed call text-back</strong> fires within 30 seconds of any unanswered call — from the business number, in plain language, with a booking link. We see 40–50% recovery rates on missed calls that would have otherwise been permanently lost. The response is fast enough that the caller is still actively thinking about the appointment.
              </p>
              <p style={{ fontFamily: "'Nicholas', serif", fontSize: '1rem', color: '#b8b6b3', lineHeight: 1.85, marginBottom: '1.25rem' }}>
                <strong style={{ color: '#0CA2A2' }}>Automated website lead response</strong> kicks off within 60 seconds of a form submission. The lead gets an immediate acknowledgment and a way to book or continue the conversation. This single change routinely shifts conversion rates on website leads from single digits to 20–30% or higher.
              </p>
              <p style={{ fontFamily: "'Nicholas', serif", fontSize: '1rem', color: '#b8b6b3', lineHeight: 1.85, marginBottom: '1.25rem' }}>
                <strong style={{ color: '#0CA2A2' }}>A unified inbox</strong> pulls phone, email, website form, Instagram, Facebook, and Google Business messages into a single view. Nothing falls through the cracks because there's no longer a separate inbox to forget to check.
              </p>
              <p style={{ fontFamily: "'Nicholas', serif", fontSize: '1rem', color: '#b8b6b3', lineHeight: 1.85, marginBottom: '1.25rem' }}>
      ...
      <section style={{ padding: '5rem 0', borderTop: '1px solid #E5E5E5', background: '#F7EDE8' }}>
        <div className="container" style={{ maxWidth: '660px', margin: '0 auto', textAlign: 'center' }}>
          <FadeItem delay={0}>
            ...
            <p style={{ fontFamily: "'Nicholas', serif", fontSize: '1rem', color: '#b8b6b3', lineHeight: 1.75, marginBottom: '2rem' }}>
