          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(200px, 1fr))', gap: '2rem', textAlign: 'center' }}>
            {stats.map((s, i) => (
              <div key={i}>
                ...
                <p style={{ fontFamily: "'Sora', sans-serif", fontSize: '0.875rem', color: '#b8b6b3', lineHeight: 1.5 }}>{s.label}</p>
              </div>
            ))}
          </div>
        </div>
                ...
                {problems.map((p, i) => (
                  <FadeItem key={i} delay={i * 0.06}>
                    <div style={{ padding: '1.5rem', background: 'rgba(255,80,80,0.03)', border: '1px solid rgba(255,80,80,0.1)', borderRadius: '10px' }}>
                      ...
                      <p style={{ fontFamily: "'Sora', sans-serif", fontSize: '0.875rem', color: '#b8b6b3', lineHeight: 1.7, paddingLeft: '2rem' }}>{p.detail}</p>
                    </div>
                  </FadeItem>
                ))}
              </div>
                  ...
                  <FadeItem key={i} delay={i * 0.06}>
                    <div style={{ padding: '1.25rem 1.5rem', borderBottom: i < solutions.length - 1 ? '1px solid rgba(167,139,250,0.08)' : 'none', display: 'flex', alignItems: 'flex-start', gap: '1rem' }}>
                      ...
                      <div>
                        ...
                        <p style={{ fontFamily: "'Sora', sans-serif", fontSize: '0.875rem', color: '#b8b6b3', lineHeight: 1.65 }}>{s.detail}</p>
                      </div>
                    </div>
                  </FadeItem>
                ))}
              ...
              <FadeItem key={name} delay={i * 0.1}>
                <div className={featured ? 'pricing-card featured' : 'pricing-card'} style={{ padding: '2rem', position: 'relative', display: 'flex', flexDirection: 'column', height: '100%' }}>
                  ...
                  <div style={{ marginTop: featured ? '1rem' : 0, flex: 1 }}>
                    ...
                    <p style={{ fontFamily: "'Sora', sans-serif", fontSize: '0.75rem', fontWeight: 600, color: '#C4B5FD', letterSpacing: '0.06em', textTransform: 'uppercase' as const, marginBottom: '1rem' }}>{subtitle}</p>
