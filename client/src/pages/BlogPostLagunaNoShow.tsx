            ...
            <div style={{ borderTop: '1px solid #E5E5E5', paddingTop: '3rem' }}>
              ...
              <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '1rem', margin: '2rem 0' }}>
                <div style={{ background: 'rgba(248,113,113,0.05)', border: '1px solid rgba(248,113,113,0.2)', borderRadius: '12px', padding: '1.5rem' }}>
                  <p style={{ fontFamily: "'Nicholas', serif", fontSize: '0.75rem', fontWeight: 700, letterSpacing: '0.1em', textTransform: 'uppercase' as const, color: '#F87171', marginBottom: '1rem' }}>Before</p>
                  <p style={{ fontFamily: "'Nicholas', serif", fontSize: '2.25rem', fontWeight: 800, color: '#ffffff', lineHeight: 1, marginBottom: '0.375rem' }}>21%</p>
                  <p style={{ fontFamily: "'Nicholas', serif", fontSize: '0.8125rem', color: '#b8b6b3', lineHeight: 1.5, margin: 0 }}>No-show rate — 11 out of 52 appointments</p>
                </div>
                <div style={{ background: 'rgba(74,222,128,0.05)', border: '1px solid rgba(74,222,128,0.2)', borderRadius: '12px', padding: '1.5rem' }}>
                  <p style={{ fontFamily: "'Nicholas', serif", fontSize: '0.75rem', fontWeight: 700, letterSpacing: '0.1em', textTransform: 'uppercase' as const, color: '#4ADE80', marginBottom: '1rem' }}>After</p>
      ...
      <section style={{ padding: '5rem 0', borderTop: '1px solid #E5E5E5', background: '#F7EDE8' }}>
        <div className="container" style={{ maxWidth: '660px', margin: '0 auto', textAlign: 'center' }}>
          <FadeItem delay={0}>
            ...
            <p style={{ fontFamily: "'Nicholas', serif", fontSize: '0.8125rem', color: '#b8b6b3', marginTop: '1rem' }}>
